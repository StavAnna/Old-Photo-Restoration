...
if __name__ == "__main__":
    ...
    # Since photos often contain mixed degradations, the restoration network should simultaneously support global and local features.     os.chdir("./Global")
    os.chdir("./Global")
    stage_1_input_dir = opts.input_folder
    ...
    ## If there is no face in the photo, jump to the end!
    ...
    # In this phase we use face detection model
    ...
    # Restoration quality on faces is most sensitive to human perception and therefore requires a network for face enhancement.
    ...
    ## Phase 4: Blending
    # In this phase we unify the enhanced face image and the restored image
    os.chdir(".././Face_Detection")
    ...
    print("Model Is Done Processing!")
